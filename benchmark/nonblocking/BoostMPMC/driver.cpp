...
int main(int argc, char *argv[]) {
  ...
  //
  cxxopts::Options options("boost_mpmc",
                           "Boost multi-producer multi-consumer "
  ...
  //
  // Chreate/join threads for benchmark:
  //
  ...
  dumpData(ovw_stats, &col_lower, "boost_mpmc_producers.txt"); 

  // Upper-half of threads (the consumers):
  range_smpl_collector col_upper(2 * nr_pairs, nr_pairs, 2 * nr_pairs, sc_runs);
  dumpData(ovw_stats, &col_upper, "boost_mpmc_consumers.txt"); 
